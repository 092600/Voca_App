...
import 'package:voca/layout/home_layout.dart';
...
class _MultipleChoiceChallengeScreenState
  ...
  Widget build(BuildContext context) {
    ...
    void answerClickedEvent(bool isAnswer, Word word) async {
      setState(() {
        isLoaded = true;
        ...
        if ((correct + nonCorrect) != questions.length) {
          questionIndex++;
          storageProvider.addTestCorrectWordCnt();
        } else {
          showDialog(
